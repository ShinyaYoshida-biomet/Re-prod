...
describe("CommandRegistry", () => {
	// Reset registry before each test if possible.
	// Since it's a singleton exported instance, we might need to clear it manually if we exposed a way,
	// or just rely on unique IDs for tests.
	// For this test, I'll use unique IDs.
